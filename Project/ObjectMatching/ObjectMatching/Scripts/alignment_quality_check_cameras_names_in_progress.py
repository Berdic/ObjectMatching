...
def calculate_ideal_points_cabin_Dooblicator_v1_54(axis):
	...
	for j in range(6):
		for i in range(8):
			...
			point.round(5,point)
			#if i is greater or equal to 4 (Pod5) pod name will be i + 2, not i+1
			if i >= 4:
				array_of_points_with_name.append(("Pod{}Camera{}".format(i+2, j+1),point))
			else:
				array_of_points_with_name.append(("Pod{}Camera{}".format(i+1, j+1),point))
	...
	for k in range(6):
		...
		if axis == 1:
			...
			point = np.array([x,z,y])
		point.round(5,point)
		array_of_points_with_name.append(("Pod5Camera{}".format(k+1),point))
		final_points_3d[k][8] = point
		final_points_2d.append(np.asarray(point))

	print("Calculated ideal points for Dooblicator v1 54")

	return np.array(final_points_2d), radius, height,array_of_points_with_name
		...
		for i in range(8):
			...
			if i==2 and j == 1:
				if axis == 0:
					...
					array_of_points_with_name.append(("Pod3Camera8",[x+0.3797104473,y,z+0.1575469724]))
					#Pod3Camera7
					final_points_2d.append([x-0.3797104473,y,z+0.1575469724])
					array_of_points_with_name.append(("Pod3Camera7",[x-0.3797104473,y,z+0.1575469724]))
					#Pod3Camera11
					final_points_2d.append([x+0.6295674132 ,y+0.2,z+0.2612159885])
					array_of_points_with_name.append(("Pod3Camera11",[x+0.6295674132 ,y+0.2,z+0.2612159885]))
					#Pod3Camera10
					final_points_2d.append([x-0.6295674132 ,y+0.2,z+0.2612159885])
					array_of_points_with_name.append(("Pod3Camera10",[x-0.6295674132 ,y+0.2,z+0.2612159885]))
					#Pod3Camera9
					final_points_2d.append([x+0.8795631114, y,z+0.3649425666])
					array_of_points_with_name.append(("Pod3Camera9",[x+0.8795631114, y,z+0.3649425666]))
					#Pod3Camera6
					final_points_2d.append([x-0.8795631114,y, z+0.3649425666])
					array_of_points_with_name.append(("Pod3Camera6",[x-0.8795631114,y, z+0.3649425666]))
				elif axis == 1:
					#Pod3Camera8
					final_points_2d.append([y,x+0.3797104473,z+0.1575469724])
					array_of_points_with_name.append(("Pod3Camera8",[y,x+0.3797104473,z+0.1575469724]))
					#Pod3Camera7
					final_points_2d.append([y,x-0.3797104473,z+0.1575469724])
					array_of_points_with_name.append(("Pod3Camera7",[y,x-0.3797104473,z+0.1575469724]))
					#Pod3Camera11
					final_points_2d.append([y+0.2,x+0.6295674132,z+0.2612159885])
					array_of_points_with_name.append(("Pod3Camera11",[y+0.2,x+0.6295674132,z+0.2612159885]))
					#Pod3Camera10
					final_points_2d.append([y+0.2,x-0.6295674132,z+0.2612159885])
					array_of_points_with_name.append(("Pod3Camera10",[y+0.2,x-0.6295674132,z+0.2612159885]))
					#Pod3Camera9
					final_points_2d.append([y, x+0.8795631114,z+0.3649425666])
					array_of_points_with_name.append(("Pod3Camera9",[y, x+0.8795631114,z+0.3649425666]))
					#Pod3Camera6
					final_points_2d.append([y,x-0.8795631114, z+0.3649425666])
					array_of_points_with_name.append(("Pod3Camera6",[y,x-0.8795631114, z+0.3649425666]))
				elif axis == 2:
					#Pod3Camera8
					final_points_2d.append([x+0.3797104473,z+0.1575469724,y])
					array_of_points_with_name.append(("Pod3Camera8",[x+0.3797104473,z+0.1575469724,y]))
					#Pod3Camera7
					final_points_2d.append([x-0.3797104473,z+0.1575469724,y])
					array_of_points_with_name.append(("Pod3Camera7",[x-0.3797104473,z+0.1575469724,y]))
					#Pod3Camera11
					final_points_2d.append([x+0.6295674132 ,z+0.2612159885,y+0.2])
					array_of_points_with_name.append(("Pod3Camera11",[x+0.6295674132 ,z+0.2612159885,y+0.2]))
					#Pod3Camera10
					final_points_2d.append([x-0.6295674132 ,z+0.2612159885,y+0.2])
					array_of_points_with_name.append(("Pod3Camera10",[x-0.6295674132 ,z+0.2612159885,y+0.2]))
					#Pod3Camera9
					final_points_2d.append([x+0.8795631114,z+0.3649425666, y])
					array_of_points_with_name.append(("Pod3Camera9",[x+0.8795631114,z+0.3649425666, y]))
					#Pod3Camera6
					final_points_2d.append([x-0.8795631114, z+0.3649425666,y])
					array_of_points_with_name.append(("Pod3Camera6",[x-0.8795631114, z+0.3649425666,y]))
...
def calculate_ideal_points_cabin_Dooblicator_v2_66(axis):
	...
	for j in range(6):
		for i in range(10):
			...
			if axis == 1:
				...
				point = np.array([x,z,y])
			point.round(5,point)
			#if i is greater or equal to 5 (Pod6) pod name will be i + 2, not i+1
			if i >= 5:
				array_of_points_with_name.append(("Pod{}Camera{}".format(i+2, j+1),point))
			else:
				array_of_points_with_name.append(("Pod{}Camera{}".format(i+1, j+1),point))
	...
	for k in range(6):
		...
		if axis == 1:
			...
			point = np.array([x,z,y])
		point.round(5,point)
		#add point name and point for pod6 frontal pod.
		array_of_points_with_name.append(("Pod6Camera{}".format(k+1),point))
		final_points_3d[k][8] = point
		final_points_2d.append(np.asarray(point))
...
def get_alignment_score(chunk):
	...
	ideal_points, IDEAL_RADIUS, IDEAL_HEIGHT, array_of_points_with_name = calculate_ideal_points(chunk.cameras)
	mean_result_X, problematic_cameras_x = get_score_for_ideal_points(chunk, ideal_points, IDEAL_RADIUS, IDEAL_HEIGHT,array_of_points_with_name)
	...
	ideal_points, IDEAL_RADIUS, IDEAL_HEIGHT, array_of_points_with_name = calculate_ideal_points(chunk.cameras, axis=1)
	mean_result_Y, problematic_cameras_y = get_score_for_ideal_points(chunk, ideal_points, IDEAL_RADIUS, IDEAL_HEIGHT,array_of_points_with_name)
	if mean_result_Y < 1:
	...
	ideal_points, IDEAL_RADIUS, IDEAL_HEIGHT, array_of_points_with_name = calculate_ideal_points(chunk.cameras, axis=2)
	mean_result_Z, problematic_cameras_z = get_score_for_ideal_points(chunk, ideal_points, IDEAL_RADIUS, IDEAL_HEIGHT,array_of_points_with_name)
	if mean_result_Z < 1:
		return mean_result_Z

	min_value = min(mean_result_Y, mean_result_X, mean_result_Z)
	print("Array of points with names: ", array_of_points_with_name)
	print("X score : ", mean_result_X)
	print("X problematic cameras: ", problematic_cameras_x)
	print("------------------------------------------")
	print("Y score : ", mean_result_Y)
	print("Y problematic cameras: ", problematic_cameras_y)
	print("------------------------------------------")
	print("Z score : ", mean_result_Z)
	print("Z problematic cameras: ", problematic_cameras_z)
	print("------------------------------------------")
	if min_value == mean_result_X:
		print("X is minimum!");
		return mean_result_X, problematic_cameras_x
	elif min_value == mean_result_Y:
		print("Y is minimum!");
		return mean_result_Y, problematic_cameras_y
	else:
		print("Z is minimum!");
		return mean_result_Z, problematic_cameras_z

	


doc = PhotoScan.app.document
a,b = get_alignment_score(doc.chunk)

print("FINAL SCORE", a)
print("PROBLEMATIC CAMERAS", b)
